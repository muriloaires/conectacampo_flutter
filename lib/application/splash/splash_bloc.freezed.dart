...
class _$SplashStateTearOff {
  ...
  _SplashState call({required Option<String> firstScreen}) {
    return _SplashState(
...
/// @nodoc
mixin _$SplashState {
  Option<String> get firstScreen => throw _privateConstructorUsedError;
...
abstract class $SplashStateCopyWith<$Res> {
  ...
  $Res call({Option<String> firstScreen});
}
...
class _$_SplashState implements _SplashState {
  const _$_SplashState({required this.firstScreen});

  @override
  final Option<String> firstScreen;

  @override
  String toString() {
    return 'SplashState(firstScreen: $firstScreen)';
  }
  ...
  @override
  int get hashCode =>
      runtimeType.hashCode ^ const DeepCollectionEquality().hash(firstScreen);
...
abstract class _SplashState implements SplashState {
  const factory _SplashState({required Option<String> firstScreen}) =
      _$_SplashState;
