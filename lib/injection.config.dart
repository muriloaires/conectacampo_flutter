...
import 'application/auth/phone_number_form/sign_in_form_bloc.dart' as _i27;
import 'application/auth/sign_up_form/bloc/sign_up_form_bloc.dart' as _i28;
import 'application/auth/sms_code_form/sms_code_form_bloc.dart' as _i30;
import 'application/buyer/adivertisements/adivertisements_bloc.dart' as _i34;
import 'application/buyer/cart/cart_bloc.dart' as _i36;
import 'application/buyer/group/group_bloc.dart' as _i37;
import 'application/buyer/menu/buyer_menu_bloc.dart' as _i35;
...
import 'application/buyer/summary/summary_bloc.dart' as _i32;
import 'application/places_form/bloc/places_form_bloc.dart' as _i18;
import 'application/profile/profile_bloc.dart' as _i20;
import 'application/seller/menu/seller_menu_bloc.dart' as _i24;
...
import 'application/seller/new_advertisement/new_advertisement_bloc.dart'
    as _i17;
import 'application/seller/reservation/seller_reservation_bloc.dart' as _i25;
import 'application/seller/summary/seller_summary_bloc.dart' as _i26;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i24.SellerMenuBloc>(() => _i24.SellerMenuBloc());
  gh.factory<_i25.SellerReservationBloc>(
      () => _i25.SellerReservationBloc(get<_i14.IReservationFacade>()));
  gh.factory<_i26.SellerSummaryBloc>(() => _i26.SellerSummaryBloc(
      get<_i6.IAdvertisementsFacade>(), get<_i14.IReservationFacade>()));
  gh.factory<_i27.SignInFormBloc>(
      () => _i27.SignInFormBloc(get<_i8.IAuthFacade>()));
  gh.factory<_i28.SignUpFormBloc>(
      () => _i28.SignUpFormBloc(get<_i8.IAuthFacade>()));
  gh.factory<_i29.SingleReservationBloc>(
      () => _i29.SingleReservationBloc(get<_i14.IReservationFacade>()));
  gh.factory<_i30.SmsCodeFormBloc>(
      () => _i30.SmsCodeFormBloc(get<_i8.IAuthFacade>()));
  gh.factory<_i31.SplashBloc>(() => _i31.SplashBloc());
  gh.factory<_i32.SummaryBloc>(
      () => _i32.SummaryBloc(get<_i14.IReservationFacade>()));
  gh.factory<_i33.AddProductBloc>(
      () => _i33.AddProductBloc(get<_i12.IProductFacade>()));
  gh.factory<_i34.AdvertisementsBloc>(
      () => _i34.AdvertisementsBloc(get<_i6.IAdvertisementsFacade>()));
  gh.factory<_i35.BuyerMenuBloc>(
      () => _i35.BuyerMenuBloc(get<_i14.IReservationFacade>()));
  gh.factory<_i36.CartBloc>(() => _i36.CartBloc(
      get<_i14.IReservationFacade>(), get<_i6.IAdvertisementsFacade>()));
  gh.factory<_i37.GroupBloc>(
      () => _i37.GroupBloc(get<_i6.IAdvertisementsFacade>()));
  return get;
}
